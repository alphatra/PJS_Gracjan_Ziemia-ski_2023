  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UserCustomizationRow:
            return UserCustomizationRow(data);
          case PollsRow:
            return PollsRow(data);
          case PollsWithStatusRow:
            return PollsWithStatusRow(data);
          case VotesRow:
            return VotesRow(data);
          case VotingResultsRow:
            return VotingResultsRow(data);
          case QuestionsRow:
