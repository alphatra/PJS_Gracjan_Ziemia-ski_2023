                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          ...
                          image: CachedNetworkImageProvider(
                            'https://rare-gallery.com/uploads/posts/350483-4k-wallpaper.jpg',
                          ),
                        ),
                      ),
                      alignment: AlignmentDirectional(0.0, 0.0),
                          ...
                          child: Container(
                            ...
                            child: FutureBuilder<List<ProfilesRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProfilesRow> imageProfilesRowList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final imageProfilesRow =
                                    imageProfilesRowList.isNotEmpty
                                        ? imageProfilesRowList.first
                                        : null;
                                return ClipRRect(
                                  borderRadius: BorderRadius.circular(90.0),
                                  child: Image.network(
                                    imageProfilesRow!.avatarUrl!,
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
